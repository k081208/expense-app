...
const MAILS: Record<string, ReturnType<typeof mail>> = {
  ...
  j1: mail("j1", "<mail@qa.jcb.co.jp>", "JCBカード2026年9月10日分お振替内容確定のご案内", "****-****-****-1111\nお振替日は毎月10日です\n年会費 1,375円", "1757000000000"),
  j2: mail("j2", "<mail@qa.jcb.co.jp>", "JCBカード2026年9月10日分お振替内容変更のご案内", "****-****-****-1111\nお振替日は毎月10日です", "1757400000000"),
};
